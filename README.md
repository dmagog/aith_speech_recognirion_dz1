# AITH: Speech Recognition and Generation - Homework 1

> Дисклеймер: это решение выполнено в рамках курса **"AITH: Speech recognition and generation"**.
>
> Файл отчёта по ДЗ: `reports/hw1_report.pdf`.
